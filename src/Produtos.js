                ...
                {this.state.editingCategoria === cat.id &&
                    <div className='input-group'>
                        <div className='input-group-btn'>
                            ...
                            <button className='btn' onClick={this.cancelEditing}>X</button>
                        </div>
                    </div>
                }
                {this.state.editingCategoria !== cat.id &&
                    <div>
                        <button className='btn btn-xs btn-danger' onClick={() => this.props.removeCategoria(cat)} >
                            <span className='glyphicon glyphicon-trash'></span>
                        </button>
                        <button className='btn btn-xs btn-warning' onClick={() => this.editCategoria(cat)} >
